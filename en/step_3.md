...
![A screenshot of the volcano erruptions project. A map shows the locations of volcano erruptions that have taken place since 2010, each is represented by a red dot.](images/volcano-map.PNG){:width=300px}
